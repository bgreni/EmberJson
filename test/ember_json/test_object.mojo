...
def test_object():
    var s = '{"thing":123}'
    var ob = Object.from_string_raises(s)
...
def test_bad_value():
    with assert_raises():
        _ = Object.from_string_raises('{"key": nil}')

def test_bytes_for_string():
    assert_equal(Object.from_string_raises('{"key": true, "foo": "bar"}').bytes_for_string(), 24)